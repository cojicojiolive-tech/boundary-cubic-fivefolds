...
_sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1)# adjacency.sage
#
# Title:
...
indexset = [
    vector(ZZ, [_sage_const_0 , _sage_const_0 , _sage_const_2 , _sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_0 ]),  # x2^2 * x4
...
def main(print_debug=False):
    ...
    for subset in combinations(indexset, dim - _sage_const_2 ):  # choose 5 of the 6
