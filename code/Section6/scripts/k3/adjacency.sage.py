...
deg = _sage_const_3    # total degree of monomials (cubic); kept for clarity
...
indexset = [
    vector(ZZ, [_sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_2 , _sage_const_0 , _sage_const_0 , _sage_const_0 ]),  # x1 * x3^2
