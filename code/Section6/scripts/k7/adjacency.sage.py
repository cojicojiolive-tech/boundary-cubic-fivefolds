...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2)# adjacency_k7.sage
# ------------------------------------------------------------
# Purpose
...
def primitive_integer_vector(v):
    ...
    vv = vector(QQ, v)
    if vv.is_zero():
        return vector(ZZ, [_sage_const_0 ]*len(vv))
...
def normal_vector_from_indexset(indexset):
    ...
    ones = matrix(QQ, [[_sage_const_1 ,_sage_const_1 ,_sage_const_1 ,_sage_const_1 ,_sage_const_1 ,_sage_const_1 ,_sage_const_1 ]])  # sum(r_i) = 0  <=>  (1,...,1)·r = 0
    A = M.stack(ones)
    K = A.right_kernel()
    ...
    r = primitive_integer_vector(K.basis()[_sage_const_0 ])
    return r
